...
"""
批量导入问答对到 RAG 系统
使用方法: python bulk_import.py [--host http://localhost:5000] [--skip-existing]
"""
import os
import sys
import time
...
def store_qa_pair(api_base: str, question: str, answer: str, skip_existing: bool, timeout: int = 30) -> tuple:
    """
...
def bulk_import(api_base: str, skip_existing: bool = True, delay: float = 0.1) -> Dict[str, int]:
    ...
    print(f"⏱️  Request delay: {delay}s")
    print("-" * 60)
